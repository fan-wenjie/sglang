...
class BatchedScanPack:
    ...
    def __init__(
        ...
        # zero-width kr and crash s_kept.max(-1). One padded row, masked off by
    ...
    def run(self, p_live=None):
        ...
        sc = self.scale
        # Fused prologue: s_kept/softmax/entropy/gate/qsk/qres/max1g and the
        ...
        # dominated the captured graph (VESTIGEKV_STATS S-sweep). Empty tier-1 pairs
