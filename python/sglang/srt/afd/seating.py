...
def seat(capacity: int, waiting: int, remainder: int = 0, overdue: bool = False) -> Seating:
...
def load(capacity: int, queue: list, remainder: list | None = None,
         overdue: bool = False) -> tuple[list, list]:
