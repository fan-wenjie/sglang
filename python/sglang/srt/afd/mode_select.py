...
Both numbers are hardware-specific. `python benchmark/afd/crossover.py` recalibrates them, and a
...
class ModeSelector:
    ...
    def __init__(
        self,
        *,
        feed_forward_us: float,
        slope_us_per_token: float,
        ...
        with self._lock:
            ...
            if reached is not None and context < reached:
                ...
                logger.warning(
                    ...
                    context,
                    reached,
                    self._mode.get(request_id, FFN_REMOTE),
                )
